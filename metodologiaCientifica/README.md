...
Minha atuação como Web Analytics, me faz utilizar diariamente o mesmo para a resolução de problemas e criação de scripts. A utilização de Javascript no ambiente WEB, para diversas necessidas, um exemplo de necessidade é a Extração do dados e manipulação dos mesmos.
